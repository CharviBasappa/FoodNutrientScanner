            ...
            <ScrollView style={styles.scrollContainer}>
              <View style={styles.details}>
                <Text style={styles.detailText}>
                  ...
                  {nutrientDetails.product_name}
                </Text>
                <Text style={styles.detailText}>
                  <Text style={styles.boldText}>Serving Size:</Text>{" "}
                  {nutrientDetails.serving_size}
                </Text>
                <Text style={styles.detailText}>
                  <Text style={styles.boldText}>Calories:</Text>{" "}
                  {nutrientDetails.calories}
                </Text>
                ...
                <TouchableOpacity
                  onPress={() =>
                    setShowMacronutrients(!showMacronutrients)
                  }
                  style={styles.sectionHeader}
                >
                  <Text style={styles.sectionHeaderText}>
                ...
                {showMacronutrients && (
                  <View style={styles.sectionContent}>
                    <Text style={styles.detailText}>
                      Fat: {nutrientDetails.macronutrients.fat}
                    </Text>
                    <Text style={styles.detailText}>
                      Saturated Fat:{" "}
                      {nutrientDetails.macronutrients.saturated_fat}
                    </Text>
                    <Text style={styles.detailText}>
                      Cholesterol:{" "}
                      {nutrientDetails.macronutrients.cholesterol}
                    </Text>
                  </View>
                )}
                ...
                {showMicronutrients && (
                  <View style={styles.sectionContent}>
                    {Object.entries(
                      nutrientDetails.micronutrients
                    ).map(([key, value], index) => (
                      <Text key={index} style={styles.detailText}>
                        {key}: {value}
                      </Text>
